...
def transcribe(**config_prm):
    ...
    s3_uncompressed = "BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch4/"
    s3_transcript = "BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch4/Transcript/"
    s3_processed = "BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch4/Processed/"
    # allfilepath = s3FileListing(bucket_name, s3_uncompressed, AUDIO_EXT)
    allfilepath = [
        "BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch4/Fuel Tank_BS6 22-23_Bolero_N6M25686.wav",
        "BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch4/Fuel Tank_BS6 22-23_Bolero_N6M25718.wav",
        "BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch4/Fuel Tank_BS6 22-23_Bolero_P5A17497_call2.wav",
        "BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch4/Fuel Tank_BS6 22-23_Bolero_P5B18977_call3.wav",
    ]
    # print(allfilepath)
    # return 0
    ...
    for path in allfilepath:
        ...
        if ext == AUDIO_EXT:
                ...
                if response.status_code == 200:
                    ...
                    if respObj["status_code"] == 0 and respObj["confidence_score"] >= 0.2:
                        ...
                        if status != False:
                            ...
                            if ln<=ln-1:
                                time.sleep(60)
                            log = {"status": 'error', "count": k, "status_code": "try error", "status_message": "error", 'lang': "en","transcribed_detected_lang": "", "ext": ext, "api_version": "", "confidence_score": "", "filepath": param["data"], "json": False}
                else:
                    log = {"status": 'error', "count": k, "status_code": response.status_code, "status_message": "", 'lang': "en","transcribed_detected_lang": "", "ext": ext, "api_version": "", "confidence_score": "", "filepath": param["data"], "json": False}
            except ConnectTimeout as e:
                log = {"status": 'error', "count": k, "status_code": 502, "status_message": "ConnectTimeout", 'lang': "en","transcribed_detected_lang": "", "ext": ext, "api_version": "", "confidence_score": "", "filepath": param["data"], "json": False}
            except ReadTimeout as e:
                log = {"status": 'error', "count": k, "status_code": 502, "status_message": "ReadTimeout", 'lang': "en","transcribed_detected_lang": "", "ext": ext, "api_version": "", "confidence_score": "", "filepath": param["data"], "json": False}
            ...
            log = {"status": "error", "count": k, "status_code": "", "status_message": "", 'lang': "en","transcribed_detected_lang": "", "ext": ext, "api_version": "", "confidence_score": "", "filepath": "", "json": False}
            logs.append(log)

        if k==10:break

    if len(allfilepath) == 0:
        logs.append({"status": '0', "count": "0", "status_code": "0", "status_message": "No files", 'lang': "en","transcribed_detected_lang": "", "ext": "NILL", "api_version": "", "confidence_score": "", "filepath": "NILL"})
