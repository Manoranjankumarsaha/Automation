...
url="http://192.168.255.6:5007/get_ideas"
url="http://13.234.134.87:5007/get_ideas"
# s3_transcript="BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch3/Transcript/json/"
# s3_getideas="BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch3/getIdeas/"

# s3_transcript="BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch2/Transcript/json/"
# s3_getideas="BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch2/getIdeas/"

# s3_transcript="BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch2/Transcript/json/"
# s3_getideas="BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch2/getIdeas/"
# s3_getideas="TextToInsights/WebApp/Bolero/getIdeas/Batch2/"
...
def get_ideas_api(**get_idea_config):  
    ...
    abc=[
            {
                "s3_transcript":"BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch1/Transcript/json/",
                "s3_getideas":"TextToInsights/WebApp/Bolero/getIdeas/Batch1/"
            },
            {
                "s3_transcript":"BoleroFuelTankProject/Bolero Fuel tank study Owner/Batch3/Transcript/json/",
                "s3_getideas":"TextToInsights/WebApp/Bolero/getIdeas/Batch3/"
            },
            {
                "s3_transcript":"BoleroFuelTankProject/Bolero Fuel Tank Study Intender/Batch1/Transcript/json/",
                "s3_getideas":"TextToInsights/WebApp/Bolero/getIdeas/Batch1/"
            },
            {
                "s3_transcript":"BoleroFuelTankProject/Bolero Fuel Tank Study Intender/Batch2/Transcript/json/",
                "s3_getideas":"TextToInsights/WebApp/Bolero/getIdeas/Batch2/"
            },
            {
                "s3_transcript":"BoleroFuelTankProject/Bolero Fuel Tank Study Intender/Batch3/Transcript/json/",
                "s3_getideas":"TextToInsights/WebApp/Bolero/getIdeas/Batch3/"
            },
            
        ]
    for dct in abc:
        s3_transcript=dct["s3_transcript"]
        s3_getideas=dct["s3_getideas"]
